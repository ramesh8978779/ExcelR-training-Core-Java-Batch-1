class Employee {
    ...
    FullTimeEmployee fullTimeEmployee = new FullTimeEmployee(101,"JYOTHI","YADAV",6000,2000,"50-50, EAST, INDIA");
            fullTimeEmployee.showDetails();
            fullTimeEmployee.sendMessage();
        
            PartTimeEmployee partTimeEmployee = new PartTimeEmployee(102,"DARSHAN","REDDY",150,80,"20-20,WEST, HYDERABAD");
